...
export function QrCodeCard() {
  ...
  return (
    <div className="flex flex-col items-center gap-3 rounded-2xl bg-white p-5 text-center shadow-sm ring-1 ring-black/5">
      ...
      <div className="rounded-xl border border-stone-200 p-3">
        <QRCodeSVG value={url} size={176} fgColor="#c2410c" />
      </div>
